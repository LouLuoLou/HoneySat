...
class LiIonBatteryCell(BatteryCell):
    ...
    def __init__(self, starting_soc=1, capacity=3.5, parameter_values=pybamm.ParameterValues("Chen2020"),
    ...
    def set_current(self, current):
        ...
        self.__steps.append(SimulationStep(pybamm.step.current(old_current,
    ...
    def __compute_simulation(self):
        with (ProcessPoolExecutor() as ex):
            steps = [step.step for step in self.__steps] + [
                pybamm.step.current(self.__current, duration=f'{self.__lookahead_time} seconds', period="1 second")]
